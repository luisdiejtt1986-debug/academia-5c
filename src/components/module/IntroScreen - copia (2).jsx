...
import { useState, useRef } from "react"; // Importamos hooks necesarios

function IntroScreen({ data, onNext, accent = "#1a6bff" }) {
  // Referencia para controlar el video
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] flex flex-col items-center justify-between p-6 pb-8 relative overflow-hidden">
      ...
      {/* CENTER: title + media (Video o Imagen) */}
          ...
          {data.video ? (
            ...
            >
              <video
                ...
                onEnded={() => setIsPlaying(false)} // Cuando termina, mostramos el botón de Play de nuevo
              />
